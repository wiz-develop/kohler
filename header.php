...
<head>
	<!-- PRODUCTION ONLY: Meta Pixel Code. Keep this block when merging test into main. -->
	<script>
	...
	fbq('init', '1044493571917966');
	fbq('track', 'PageView');
	</script>
	<noscript><img height="1" width="1" style="display:none"
	src="https://www.facebook.com/tr?id=1044493571917966&amp;ev=PageView&amp;noscript=1"
	alt=""
	/></noscript>
	<!-- END PRODUCTION ONLY: Meta Pixel Code. -->
	<!-- Google Tag Manager -->
