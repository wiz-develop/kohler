								...
								<div class="product-about__sub__item">
									...
									<ul class="product-item_detail document_list ps-3 mb-0">
										...
										<li class="document_list__item">
											<a href="<?php echo esc_url($document_url); ?>" <?php if ((int) $document_link_blank === 1) echo 'target="_blank" rel="noopener"'; ?> <?php if ($document_download) echo 'download="' . esc_attr($document_file_name) . '"'; ?>>
